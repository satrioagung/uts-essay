...
create type jadwal_status as enum ('draft', 'siap', 'berlangsung', 'selesai');
...
create type sesi_status as enum ('belum_mulai', 'sedang_mengerjakan', 'terputus', 'selesai');
...
-- Add policies in the Supabase dashboard after wiring the custom session claims.
